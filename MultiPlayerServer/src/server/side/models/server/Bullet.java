...
import server.side.LogicHelper;
import server.side.Main;
...
public class Bullet {
    ...
    public Bullet(server.side.models.Bullet bullet, float r, float g, float b){
    ...
    public boolean update(List<Box> obstacles, Vector<MainCharacter> fullCharacters, long id) {
        ...
        //collision with map
        if (x < 0 || x > Main.MAP_WIDTH || y < 0 || y > Main.MAP_HEIGTH) {
            return true;
        }

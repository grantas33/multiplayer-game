...
import server.sound.PlayerSounds;
import server.enumerators.SpaceshipType;
import server.facade.ServerBulletFacade;
import server.models.Box;
import server.models.Bullet;
...
public class MainCharacter {
	...
	private List<server.models.server.Bullet> bullets;
	...
	public MainCharacter(int width, int height, int hp, long id, List<Bullet> newBullets) {
		...
		bullets = Collections.synchronizedList(new ArrayList<server.models.server.Bullet>());
	...
	List<Box> update(List<Box> tiles, Vector<MainCharacter> fullCharacters) {
		...
		synchronized (bullets) {
			...
			Iterator<server.models.server.Bullet> itr = bullets.listIterator();
			while (itr.hasNext()) {
				
				server.models.server.Bullet bullet = itr.next();
	...
	public List<server.models.server.Bullet> getBullets() {
		return bullets;
	}
	...
	public void setBullets(List<server.models.server.Bullet> bullets) {
